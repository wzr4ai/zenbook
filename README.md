...
| 模块 | 仓库 | 技术栈 | 说明 |
| :--- | :--- | :--- | :--- |
| **Core API** | [**zenbook-backend**](https://github.com/wzr4ai/zenbook-backend) | FastAPI, PostgreSQL, Redis | 核心调度算法、数据管理与 API 服务。 |
| **WeApp** | [**zenbook-weapp**](https://github.com/wzr4ai/zenbook-weapp) | Uni-App (Vue3), WeChat MP | 微信小程序客户端，包含客户预约与管理员功能。 |
